import { c as createLucideIcon, i as isEasingArray, V as VisualElement, a as createBox, r as reactExports, h as hasReducedMotionListener, b as initPrefersReducedMotion, p as prefersReducedMotion, M as MotionConfigContext, d as resolveElements, e as mixNumber, f as removeItem, g as isMotionValue, k as defaultOffset, l as createGeneratorEasing, n as fillOffset, o as isGenerator, s as secondsToMilliseconds, q as progress, t as isSVGElement, v as isSVGSVGElement, S as SVGVisualElement, H as HTMLVisualElement, w as visualElementStore, x as animateSingleValue, y as animateTarget, z as motionValue, B as spring, C as useConstant, j as jsxRuntimeExports, R as React, D as reactDomExports, E as ReactDOM, F as cn, m as motion, A as AnimatePresence, I as Bell } from "./index-Ch_J1oJE.js";
import { G as GlassButton, a as GlassCard } from "./GlassCard-B3o3pxl0.js";
import { X, d as useAlarms } from "./use-clock-data-lJiL_BHs.js";
...
const BellPlus = createLucideIcon("bell-plus", __iconNode$1);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function MathDismissalDialog({
  ...
  const [problem] = reactExports.useState(() => generateMathProblem());
  const [answer, setAnswer] = reactExports.useState("");
  const [isWrong, setIsWrong] = reactExports.useState(false);
  const [scope, animate] = useAnimate();
  const inputRef = reactExports.useRef(null);
  const isCorrect = answer.trim() !== "" && Number.parseInt(answer.trim(), 10) === problem.answer;
  reactExports.useEffect(() => {
    if (open) {
      setAnswer("");
      setIsWrong(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (o) => !o && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "text-vibrant-primary flex items-center gap-2 text-lg font-bold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "w-5 h-5 text-primary" })
            }
          ),
          "Alarm Ringing"
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 space-y-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl p-4 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-vibrant-secondary text-sm mb-2", children: "Solve to dismiss" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-display text-2xl font-bold text-vibrant-primary", children: problem.question })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: scope, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Label,
              {
                htmlFor: "math-answer",
            ...
            isWrong && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
...
function AlarmFormDialog({
  ...
  const handleSave = () => {
    onSave(form, editAlarm == null ? void 0 : editAlarm.id);
    onClose();
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (o) => !o && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-vibrant-primary font-bold text-lg", children: editAlarm ? "Edit Alarm" : "New Alarm" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 mt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "time",
              value: timeValue,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-vibrant-secondary text-sm", children: "Repeat" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5 flex-wrap", children: DAY_FULL.map((day, idx) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: cn(
                    ...
                    active ? "text-[oklch(0.08_0.02_245)] shadow-glass-glow" : "glass text-vibrant-tertiary hover:text-vibrant-secondary hover:border-white/20"
                  ),
                  style: active ? {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl p-3 flex items-center justify-between gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Brain, { className: "w-4 h-4 text-primary" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-vibrant-primary text-sm font-medium", children: "Math to dismiss" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-vibrant-tertiary text-xs", children: "Solve a problem to turn off" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Switch,
              {
                ...
                onCheckedChange: (v) => setForm((f) => ({ ...f, requireMathProblem: v })),
                ...
                children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: cn(
                          ...
                          alarm.isEnabled ? "text-vibrant-primary" : "text-vibrant-tertiary"
                        ),
                        children: formatAlarmTime(hour, minute)
                      }
                    ),
                    alarm.requireMathProblem && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "span",
                      {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: cn(
                        "text-sm truncate",
                        alarm.isEnabled ? "text-vibrant-secondary" : "text-vibrant-tertiary"
                      ),
                      children: alarm.name || "Alarm"
                    }
                  ),
                  activeDays.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 mt-2 flex-wrap", children: DAY_LABELS.map((day, idx) => {
                    ...
                    return isActive ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        style: {
                          background: alarm.isEnabled ? "oklch(0.75 0.18 220 / 0.22)" : "oklch(0.4 0.02 245 / 0.3)",
                          color: alarm.isEnabled ? "oklch(0.85 0.12 220)" : "oklch(0.5 0.03 245)",
                          border: alarm.isEnabled ? "1px solid oklch(0.75 0.18 220 / 0.3)" : "1px solid oklch(0.4 0.02 245 / 0.2)"
                        },
                        children: day
                      },
                      day
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Switch,
                {
                  ...
                  className: cn(
                    ...
                    alarm.isEnabled && "data-[state=checked]:bg-primary shadow-[0_0_10px_oklch(0.75_0.18_220_/_0.4)]"
                  )
                }
              )
            ] })
...
function AlarmPage() {
  ...
  const [ringTarget, setRingTarget] = reactExports.useState(null);
  const sortedAlarms = reactExports.useMemo(
    () => [...alarms].sort((a, b) => {
  ...
  const handleSaveForm = reactExports.useCallback(
    (form, id) => {
      const record = {
        id: id ?? generateId(),
        name: form.name,
  ...
  const handleDismissMath = reactExports.useCallback(() => {
    setRingTarget(null);
  }, []);
  const handleRing = reactExports.useCallback((alarm) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
            ...
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                GlassButton,
                {
                  variant: "default",
                  size: "md",
                  leftIcon: /* @__PURE__ */ jsxRuntimeExports.jsx(BellPlus, { className: "w-4 h-4 text-primary" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 space-y-3", "data-ocid": "alarm.list", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "popLayout", children: sortedAlarms.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "w-9 h-9 text-vibrant-tertiary" })
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        style: {
                          background: "radial-gradient(circle, oklch(0.75 0.18 220 / 0.08) 0%, transparent 70%)"
                        }
                      }
                    )
                  ]
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-vibrant-secondary font-medium text-lg", children: "No alarms set" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-vibrant-tertiary text-sm mt-1", children: 'Tap "Add Alarm" to get started' })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                GlassButton,
                {
                  ...
                  children: "Add Your First Alarm"
                }
              )
            ]
          },
          "empty"
        ) : sortedAlarms.map((alarm, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          AlarmCard,
          {
            alarm,
            index,
